    ...
    public class SessionHandler //: ISessionHandler
    {
        ...
        public String RndA
        {
            ...
            set
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exception("RndA[" + value + "] 設定錯誤:" + ex.Message);
                }
            }
        }
        private byte[] rndA;
        ...
        public String RndB
        {
            ...
            set
            {
                ...
                {
                    //log.Error(ex.StackTrace);
                    throw new Exception("RndB[" + value + "] 設定錯誤:" + ex.Message);
                }
            }
        }
        private byte[] rndB;
        ...
        {
            this.AesCryptor = new Kms.Crypto.SymCryptor("AES");
            this.KeyDeriver = new Kms.Crypto.Aes128KeyDeriver()
            {
            ...
            this.ByteWorker = new Kms.Crypto.ByteWorker();
            this.PaddingHelper = new Kms.Crypto.Pkcs7PaddingHelper()
            {
                BlockSize = 16,
                ByteWorker = new Kms.Crypto.ByteWorker()
            };
            this.SeedKeyHex = "5C9A1031BE73561663B393DBFEFDEE5A";
        ...
        public string TId
        {
            ...
            set
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exception("TID[" + value + "] 設定錯誤:" + ex.Message);
                }
            }
        }
